...
/*   Updated: 2023/09/10 01:00:09 by yunjcho          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const &form)
{
	...
	{
		std::cout << "[Bureaucrat::INFO ExecuteForm() SUCCESS] " << this->name << " executed " << form.getFormName() << std::endl;
	}
	else
		throw std::runtime_error("[Bureaucrat::INFO ExecuteForm() FAILURE] Explicit error");
}
